...
We only use prefix and suffix variables.
We don't count the required output[] array as extra space.

If the interviewer counts the output array, then space is O(n).*/
